...
public class InitData implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void insertTestData() {
        ...
        a3.setPrix(12.99);
        a3.setDescription("Distributeur de nourriture sèche, croquettes, biscuits ou snacks pour chats et chiens Plastique robuste avec couvercle amovible");
        em.persist(a3);
